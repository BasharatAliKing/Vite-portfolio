      ...
      <section className=" flex bg-white  flex-col gap-4 md:gap-6 lg:gap-9 font-saira py-6 md:py-10  px-2 sm:px-5 md:px-10 xl:px-16">
        ...
        <div className="flex flex-col md:flex-row ">
          <div className="text-sm md:text-base  lg:text-xl md:w-1/2   font-normal text-gray-700">
            ...
            have already built projects using HTML CSS and javascript. If you
            need a front-end web developer feel free to contact me. I Can do
            your work as you want. And if you need a React js developer then you
            can contact me i make do this at a good budget. If you want to visit
            my Gig then the link is given below at Contact session.{" "}
            <span className="text-[#d90a2c]">Thanks.... to you</span>
          </div>
          <div className="md:w-1/2 flex justify-center mt-5 md:mt-0 ">
            <img
              src="../public/user.jpg"
              className="border-8 rounded-tl-3xl rounded-br-3xl border-[#d90a2c] w-[70%] sm:w-[50%] md:w-[70%] lg:w-[50%]"
              alt="my-pic"
            />
          </div>
        </div>
        ...
        <div className="flex gap-3 md:gap-5 flex-wrap items-center">
          <img className="w-[10%] md:w-[7%] lg:w-[5%]" src="../public/vscode.png" alt="" />
          <img className="w-[10%] md:w-[7%] lg:w-[5%]" src="../public/html.png" alt="" />
          <img className="w-[10%] md:w-[7%] lg:w-[5%]" src="../public/css.png" alt="" />
          <img className="w-[10%] md:w-[7%] lg:w-[5%]" src="../public/js.png" alt="" />
          <img className="w-[10%] md:w-[7%] lg:w-[5%]" src="../public/logo192.png" alt="" />
          <img className="w-[10%] md:w-[7%] lg:w-[5%]" src="../public/bootstrap.png" alt="" />
          <img className="w-[10%] md:w-[7%] lg:w-[5%]" src="../public/tailwind.png" alt=""/>
          <img className="w-[10%] md:w-[7%] lg:w-[5%]" src="../public/nodejs.png" alt="" />
          <img className="w-[10%] md:w-[7%] lg:w-[5%]" src="../public/mongodb.png" alt="my-img" />
        </div>
      </section>
  );
}
